    ...
    ZarrArrayMetadata &oOutputArrayMetadata)
{
    ...
    if (m_poCodecSequence->SupportsPartialDecoding())
    {
    ...
    inputArrayMetadataIndex.anBlockSizes = m_oInputArrayMetadata.anBlockSizes;
    ...
    else if (indexCodecs.size() >= 1 &&
             (indexCodecs[0]->GetName() == ZarrV3CodecBytes::NAME ||
