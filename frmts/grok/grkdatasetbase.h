...
struct GRKCodecWrapper
{
    ...
    jp2_image *psImage = nullptr;  ///< Decoded/encoded image (Grok-owned)
...
struct JP2GRKDatasetBase : public JP2DatasetBase
{
     ...
     * @param swath_x0, swath_y0 Swath origin in image coordinates
     * @param swath_width, swath_height Swath size
     ...
     * @param nRasterXSize image width
     * @param nRasterYSize image height
     * @param nBlockXSize block width
     * @param nBlockYSize block height
