...
%destructor { delete $$; } C_EXPR_TOK_NUMBER C_EXPR_TOK_IDENTIFIER C_EXPR_TOK_FUNCTION_SINGLE_ARG C_EXPR_TOK_FUNCTION_TWO_ARG C_EXPR_TOK_FUNCTION_MULTIPLE_ARG
    ...
    | C_EXPR_TOK_FUNCTION_MULTIPLE_ARG '(' value_expr_list ')'
        {
            ...
            $$->papoSubExpr = std::move($3->papoSubExpr);
            delete $3;
        }
