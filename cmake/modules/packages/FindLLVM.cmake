...
if (LLVM_FOUND)
    find_library(LLVM_CLANG_CPP_LIBRARY clang-cpp PATHS ${LLVM_LIBRARY_DIRS} NO_DEFAULT_PATH)
    if (NOT LLVM_CLANG_CPP_LIBRARY)
...
if (LLVM_FOUND)
  ...
  message(STATUS "  clang-cpp libraries: ${LLVM_CLANG_CPP_LIBRARY}")
endif()
