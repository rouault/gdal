...
Starting with GDAL 3.11, two modes are possible, depending on the value of
...
This mode is the default one since GDAL 3.11 for products that contain geolocation
...
-  .. oo:: L1B_MODE
      ...
      will be reported. In the GRANULE mode (only one supported before 3.11),
